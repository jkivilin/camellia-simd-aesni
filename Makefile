...
CFLAGS = -O2 -Wall
CFLAGS_SIMD128 = $(CFLAGS) -march=sandybridge -mtune=native -msse4.1 -maes
CFLAGS_SIMD256 = $(CFLAGS) -march=sandybridge -mtune=native -mavx2 -maes
LDFLAGS = -lcrypto
...
camellia_simd128_x86_aesni.o: camellia_simd128_x86_aesni.c
	$(CC_X86_64) $(CFLAGS_SIMD128) -c $< -o $@

camellia_simd128_x86_aesni_avx2.o: camellia_simd128_x86_aesni.c
	$(CC_X86_64) $(CFLAGS_SIMD256) -c $< -o $@
...
camellia_simd128_x86_aesni_i386.o: camellia_simd128_x86_aesni.c
	$(CC_I386) $(CFLAGS_SIMD128) -c $< -o $@

camellia_simd128_x86_aesni_avx2_i386.o: camellia_simd128_x86_aesni.c
	$(CC_I386) $(CFLAGS_SIMD256) -c $< -o $@
