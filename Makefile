...
clean:
	rm camellia_simd128_x86_aesni.o \
	   camellia_simd128_x86_aesni_avx2.o \
	...
	rm camellia_simd128_x86_aesni_i386.o \
	   camellia_simd128_x86_aesni_avx2_i386.o \
	...
	rm camellia_simd128_x86_aesni_aarch64.o \
	   main_simd128_aarch64.o || true
	rm test_simd128_intrinsics_aarch64 || true

test_simd128_intrinsics_x86_64: camellia_simd128_x86_aesni.o \
				main_simd128.o
	$(CC_X86_64) $^ -o $@ $(LDFLAGS)

test_simd256_intrinsics_x86_64: camellia_simd128_x86_aesni_avx2.o \
				camellia_simd256_x86_aesni.o \
				main_simd256.o
	$(CC_X86_64) $^ -o $@ $(LDFLAGS)
...
test_simd128_intrinsics_i386: camellia_simd128_x86_aesni_i386.o \
			      main_simd128_i386.o
	$(CC_I386) $^ -o $@ $(LDFLAGS)

test_simd256_intrinsics_i386: camellia_simd128_x86_aesni_avx2_i386.o \
			      camellia_simd256_x86_aesni_i386.o \
			      main_simd256_i386.o
	$(CC_I386) $^ -o $@ $(LDFLAGS)

test_simd128_intrinsics_aarch64: camellia_simd128_x86_aesni_aarch64.o \
				 main_simd128_aarch64.o
	$(CC_AARCH64) $^ -o $@ $(LDFLAGS)

camellia_simd128_x86_aesni.o: camellia_simd128_with_aes_instruction_set.c
	$(CC_X86_64) $(CFLAGS_SIMD128_X86) -c $< -o $@

camellia_simd128_x86_aesni_avx2.o: camellia_simd128_with_aes_instruction_set.c
...
camellia_simd128_x86_aesni_i386.o: camellia_simd128_with_aes_instruction_set.c
	$(CC_I386) $(CFLAGS_SIMD128_X86) -c $< -o $@

camellia_simd128_x86_aesni_avx2_i386.o: camellia_simd128_with_aes_instruction_set.c
...
camellia_simd128_x86_aesni_aarch64.o: camellia_simd128_with_aes_instruction_set.c
